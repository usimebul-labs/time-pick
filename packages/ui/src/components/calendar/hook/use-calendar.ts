import { addDays, eachDayOfInterval, endOfDay, endOfMonth, endOfWeek, isAfter, isBefore, isSameMinute, isSameMonth, startOfDay, startOfMonth, startOfWeek } from "date-fns";
...
export function useCalendar({ type, calendarDate, selectedDates, startHour = 9, endHour = 18, minDate, maxDate }: UseCalendarProps) {
